  ...
  <ButtonGroup.Root>
    ...
    <ButtonGroup.Root>
      ...
      <DropdownMenu.Root>
        ...
        <DropdownMenu.Content align="end" class="w-48 [--radius:1rem]">
          <DropdownMenu.Group>
          ...
          <DropdownMenu.Group>
            <DropdownMenu.Item value="snooze">
              <ClockIcon />
              Snooze
            </DropdownMenu.Item>
            <DropdownMenu.Item value="calendar">
              <CalendarPlusIcon />
              Add to Calendar
            </DropdownMenu.Item>
            <DropdownMenu.Item value="list">
              <ListFilterPlusIcon />
              Add to List
            </DropdownMenu.Item>
            <DropdownMenu.Sub>
          ...
          <DropdownMenu.Separator />
          <DropdownMenu.Group>
            <DropdownMenu.Item value="trash" variant="destructive">
              <Trash2Icon />
              Trash
            </DropdownMenu.Item>
          </DropdownMenu.Group>
